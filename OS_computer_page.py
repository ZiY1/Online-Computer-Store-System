...
class OS_computers_page(tk.Frame):

    def __init__(self, OS_name = None ,customer_name = None, customer_username = None,
                        customer_Id = None,master = None):
        tk.Frame.__init__(self, master)
        self.OS = OS_name

        self.master.title( f"{self.OS} Computers Page" )
    ...
    def create_widgets(self):
        ...
        if self.Customer_Name == None:
            ...
            self.LabelTitle = tk.ttk.Label( self.top, 
                                            text = f"Recommended {self.OS} Computers", 
        ...
        for i in range(10): # Only the top 10 sold computers will be shown
            ...
            computer_type = df_OS.iloc[i]['Type']
    ...
    def command_computers(self, computer_name, computer_type):
        ...
        if self.Customer_Name == None: # We are in the guess account
            generalized_item.generalized_item( coming_from = "OS_computer_page",
