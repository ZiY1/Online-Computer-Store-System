...
class guest_welcome_page(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.LabelTitle = tk.ttk.Label( self.top, 
                                        text = "Welcome to Lenovo Store!\n  How can we help you?", 
                                        style =  "LabelTitle.TLabel"  
                                      )
        self.LabelTitle.place( relx = 0.105, rely = 0.100, 
                               relwidth = 0.832, relheight = 0.195 
                            )
        ...
        self.CommandContinue.place( relx=0.240, rely=0.430, 
                                    relwidth=0.520, relheight=0.120
                                  )
        ...
        self.GuestSignUp.place(  relx=0.240, rely=0.580,
                                 relwidth=0.520, relheight=0.120
                              )
